...
class _ToastWidgetState extends State<_ToastWidget> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    _slideAnimation = Tween<Offset>(
      begin: Offset(widget.isRTL ? -0.15 : 0.15, 0.0),
      end: Offset.zero,
  ...
  Widget build(BuildContext context) {
    ...
    // Provide Directionality to the toast content to correctly mirror the Row if needed.
    return Positioned(
      top: 100, // Below Navbar
      left: widget.isRTL ? 24 : null,
      right: widget.isRTL ? null : 24,
      child: Material(
